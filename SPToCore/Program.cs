...
namespace SPToCore
{
    ...
    {
        //public static string P_ConnectionString = @"data source=PETER-WAKABI\SQL_2017;initial catalog=UNEB;persist security info=True;user id=sa;password=**Root@85;Connection Timeout=3000;";
        //public static string P_NameSpace = "LVR_Core";
        //public static string P_ContextSource = "unebContext";
        ...
        //public static string P_OutPutPhysicalFolder = @"C:\Software Development\SPtoCore\LVR_Core";
